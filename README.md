...
Please visit the [Downloads](https://github.com/m-kainz/GIDInd/wiki/Downloads) Page to access executable files for Windows and Linux (does NOT require active MATLAB license to run) or source codes (requires active MATLAB license to run). The link always forwards to the latest version. Please use the version with the latest date to access all functions.
## Help 
